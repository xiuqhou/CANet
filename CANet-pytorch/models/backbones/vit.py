...
class VisionTransformerBackbone(BaseBackbone):
    ...
    model_weights = {
        ...
        "vit_b_16_swag_e2e_v1": ViT_B_16_Weights.IMAGENET1K_SWAG_E2E_V1,
        "vit_b_16_swag_linear_v1": ViT_B_16_Weights.IMAGENET1K_SWAG_LINEAR_V1,
        "vit_b_32": ViT_B_32_Weights.IMAGENET1K_V1,
        "vit_l_16": ViT_L_16_Weights.IMAGENET1K_V1,
        "vit_l_16_swag_e2e_v1": ViT_L_16_Weights.IMAGENET1K_SWAG_E2E_V1,
        "vit_l_16_swag_linear_v1": ViT_L_16_Weights.IMAGENET1K_SWAG_LINEAR_V1,
        "vit_l_32": ViT_L_32_Weights.IMAGENET1K_V1,
        "vit_h_14_swag_e2e_v1": ViT_H_14_Weights.IMAGENET1K_SWAG_E2E_V1,
        "vit_h_14_swag_linear_v1": ViT_H_14_Weights.IMAGENET1K_SWAG_LINEAR_V1,
    }
...
if __name__ == "__main__":
    net = VisionTransformerBackbone(
        arch="vit_b_16",
        return_indices=(0, 1, 2, 3),
    )

    weights = load_checkpoint(
        "https://hf-mirror.com/Yuxin-CV/EVA-02/resolve/main/eva02/det/eva02_L_m38m_to_o365.pth"
    )["model"]
    # transfer pretrained weights from huggingface
    src_prefix = [
        "backbone.net.patch_embed.proj.",
        "backbone.net.rope_win.",
        "backbone.net.rope_glb.",
    ...
    tgt_prefix = [
        ...
        "0.encoder.rope_win.",
        "0.encoder.rope_glb.",
        "0.encoder.pos_embedding",
    ]
    for i in range(24):
        src_prefix.append(f"backbone.net.blocks.{i}.norm1.")
        src_prefix.append(f"backbone.net.blocks.{i}.norm2.")
        src_prefix.append(f"backbone.net.blocks.{i}.attn.")
        tgt_prefix.append(f"0.encoder.layers.encoder_layer_{i}.ln_1.")
        tgt_prefix.append(f"0.encoder.layers.encoder_layer_{i}.ln_2.")
        tgt_prefix.append(f"0.encoder.layers.encoder_layer_{i}.self_attention.")
    for i in range(24):
        src_prefix.append(f"backbone.net.blocks.{i}")
        tgt_prefix.append(f"0.encoder.layers.encoder_layer_{i}")

    src_prefix += [
        "backbone.simfp_2.0.weight",
        "backbone.simfp_2.0.bias",
        "backbone.simfp_2.1.weight",
        "backbone.simfp_2.1.bias",
        "backbone.simfp_2.3.weight",
        "backbone.simfp_2.3.bias",
        "backbone.simfp_2.4.weight",
        "backbone.simfp_2.4.norm.weight",
        "backbone.simfp_2.4.norm.bias",
        "backbone.simfp_2.5.weight",
        "backbone.simfp_2.5.norm.weight",
        "backbone.simfp_2.5.norm.bias",
    ]
    tgt_prefix += [
        "1.stage_2.0.weight",
        "1.stage_2.0.bias",
        ...
        "1.stage_2.3.weight",
        "1.stage_2.3.bias",
        "1.stage_2.4.0.weight",
        "1.stage_2.4.1.weight",
        "1.stage_2.4.1.bias",
        "1.stage_2.5.0.weight",
        "1.stage_2.5.1.weight",
        "1.stage_2.5.1.bias",
    ]

    src_prefix += [
        "backbone.simfp_3.0.weight",
        "backbone.simfp_3.0.bias",
        "backbone.simfp_3.1.weight",
        "backbone.simfp_3.1.norm.weight",
        "backbone.simfp_3.1.norm.bias",
        "backbone.simfp_3.2.weight",
        "backbone.simfp_3.2.norm.weight",
        "backbone.simfp_3.2.norm.bias",
    ]
    tgt_prefix += [
        "1.stage_3.0.weight",
        "1.stage_3.0.bias",
        "1.stage_3.1.0.weight",
        "1.stage_3.1.1.weight",
        "1.stage_3.1.1.bias",
        "1.stage_3.2.0.weight",
        "1.stage_3.2.1.weight",
        "1.stage_3.2.1.bias",
    ]

    src_prefix += [
        "backbone.simfp_4.0.weight",
        "backbone.simfp_4.0.norm.weight",
        "backbone.simfp_4.0.norm.bias",
        "backbone.simfp_4.1.weight",
        "backbone.simfp_4.1.norm.weight",
        "backbone.simfp_4.1.norm.bias",
    ]
    tgt_prefix += [
        "1.stage_4.0.0.weight",
        "1.stage_4.0.1.weight",
        "1.stage_4.0.1.bias",
        "1.stage_4.1.0.weight",
        "1.stage_4.1.1.weight",
        "1.stage_4.1.1.bias",
    ]

    src_prefix += [
        "backbone.simfp_5.1.weight",
        "backbone.simfp_5.1.norm.weight",
        "backbone.simfp_5.1.norm.bias",
        "backbone.simfp_5.2.weight",
        "backbone.simfp_5.2.norm.weight",
        "backbone.simfp_5.2.norm.bias",
    ]
    tgt_prefix += [
        "1.stage_5.1.0.weight",
        "1.stage_5.1.1.weight",
        "1.stage_5.1.1.bias",
        "1.stage_5.2.0.weight",
        "1.stage_5.2.1.weight",
        "1.stage_5.2.1.bias",
    ]
    for src_p, tgt_p in zip(src_prefix, tgt_prefix):
        for key in list(weights.keys()):
            if key.startswith(src_p):
                weights[tgt_p + key[len(src_p):]] = weights.pop(key)
