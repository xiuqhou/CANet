...
class RegionProposalNetwork(torch.nn.Module):
    ...
    def __init__(
        ...
        nms_thresh: Union[Dict[str, float], float],
    ...
    def nms_thresh(self) -> float:
        if isinstance(self._nms_thresh, float):
            return self._nms_thresh
        if self.training:
            return self._nms_thresh["training"]
        return self._nms_thresh["testing"]
    ...
    def assign_targets_to_anchors(
        ...
        for anchors_per_image, targets_per_image in zip(anchors, targets):
            ...
            if gt_boxes.numel() == 0:
                ...
                matched_idxs = self.proposal_matcher(
                    bbox_pred=anchors_per_image, gt_bboxes=gt_boxes
                )
