...
class ABFPN(BaseModule):
    ...
    def __init__(self,
        ...
        super(ABFPN, self).__init__(init_cfg)
...
if __name__ == '__main__':
    ...
    out_channels=256
    num_outs=5
    abfpn1 = ABFPN(in_channels, out_channels, num_outs, attention=True)
    abfpn2 = ABFPN(in_channels, out_channels, num_outs, attention=False)
